...
export const Toolbar: React.FC<any> = ({
  ...
  const renderShow = () => {
    return (
      <div className="toolbar-out-wrap">
        <div className="toolbar-wrap">
          <div className="toolbar-hide" onClick={() => setHide(true)}>
  ...
  const renderHide = () => {
    return (
      <div className="toolbar-show" onClick={() => setHide(false)}>
        <FontAwesomeIcon icon={faAngleDoubleRight} />
      </div>
    );
  };
  return hide ? renderHide() : renderShow();
};
